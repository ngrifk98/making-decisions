...
if (rain) {
  if (temperature >= 80) {
    console.log("It's raining. Wear a t-shirt and take an umbrella.")
  } else if (temperature >= 60 && temperature < 80) {
    console.log("It's raining. Wear a rain-jacket.");
  } else if (temperature < 60) {
    console.log("It's raining. Wear a jacket and carry an umbrella.");
  }
} else {
  if (temperature >= 80) {
    console.log("It's not raining. Wear a light and breathable outfit.");
  } else if (temperature >= 60 && temperature < 80) {
    console.log("It's not raining. Wear a comfortable outfit.");
  } else if (temperature < 60) {
    console.log("It's not raining. Wear a warm jacket.");
  }
}
...
//CODE HERE
console.log("\nPROBLEM 10")
let changeMyMind1 = false;

changeMyMind1 = !changeMyMind1;

console.log(changeMyMind1);
...
while (z > 0) {
  ...
  ctdown = ctdown.slice(0, -1); // Remove the trailing comma
  console.log(ctdown);
  z--;
}
